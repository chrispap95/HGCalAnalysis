...
//******************************************************************************
            ...
            for (const auto & it : *(PCaloHits.product())) {
                ...
                if (nameDetector_ == "HCal") {
                    ...
                    << "(" << cellGeometry->getPosition().x() << ", " << cellGeometry->getPosition().y()
                    << ", " << cellGeometry->getPosition().z() << ") " << std::endl;
                    ...
                    if (hgcCons_[index]->geomMode() == HGCalGeometryMode::Square) {
                        ...
                        // Hexagons
                        //---------------------------------------------------
                        } else if ((hgcCons_[index]->geomMode() == HGCalGeometryMode::Hexagon8) ||
                ...
                << it.time() << " " << it.time()-tof << " " << subdet << " " << layer << " "
                << "(" << gcoord.x() << ", " << gcoord.y() << ", " << gcoord.z() << ") "
                << gcoord.getEta() << " " << gcoord.getPhi() << " " << std::endl;
